...
{,
  ...
  {,
    ...
    (float)(5000.f) dribbleRange, /**< Planned look ahead dribble kick range. */
    (float)(300.f) safeDistanceToFieldBoarder, /**< Dribble range + this threshold shall not touch the field border. */
