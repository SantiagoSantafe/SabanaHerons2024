...
#include <memory>
#include "../../../../../Src/Libs/SimulatedNao/Views/AnnotationView.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AnnotationWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AnnotationWidget_t qt_meta_stringdata_AnnotationWidget = {
    {
QT_MOC_LITERAL(0, 16) // "AnnotationWidget"
...
const QMetaObject AnnotationWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_AnnotationWidget.offsetsAndSize,
    qt_meta_data_AnnotationWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AnnotationWidget_t
, QtPrivate::TypeAndForceComplete<AnnotationWidget, std::true_type>
...
void *AnnotationWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AnnotationInfo::Listener"))
        return static_cast< AnnotationInfo::Listener*>(this);
