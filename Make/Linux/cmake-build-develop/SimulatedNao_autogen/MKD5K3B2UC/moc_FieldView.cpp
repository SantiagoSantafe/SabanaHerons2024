...
#include <memory>
#include "../../../../../Src/Libs/SimulatedNao/Views/FieldView.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FieldWidget_t, stringdata0) + ofs), len 
...
const QMetaObject FieldWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<DrawingWidget::staticMetaObject>(),
    qt_meta_stringdata_FieldWidget.offsetsAndSize,
...
void *FieldWidget::qt_metacast(const char *_clname)
{
    ...
    return DrawingWidget::qt_metacast(_clname);
}

int FieldWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DrawingWidget::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
